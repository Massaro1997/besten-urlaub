...
function Scene2_Reel() {
  const destinations = [
    { src: 'assets/mallorca.webp',  name: 'Maiorca',    country: 'Spagna',     vibe: 'Sette notti, tutto incluso' },
    { src: 'assets/santorini.webp', name: 'Santorini',  country: 'Grecia',     vibe: 'Vista caldera, cinque notti' },
    { src: 'assets/sansibar.webp',  name: 'Zanzibar',   country: 'Tanzania',   vibe: 'Spiaggia bianca, dieci notti' },
  ];
        ...
        return (
          <div style={{
            ...
            <div style={{
              ...
              Die besten Deals?<br/>
              <span style={{ color: BU.blue }}>Bekommst du zuerst.</span>
            </div>
